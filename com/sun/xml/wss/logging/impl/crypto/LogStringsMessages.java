...
public final class LogStringsMessages {
    ...
    public static Localizable localizableWSS_1243_BST_DECODING_ERROR() {
        return messageFactory.getMessage("WSS1243.bst.decoding.error");
    }
     ...
     * 
     */
    public static String WSS_1243_BST_DECODING_ERROR() {
        return localizer.localize(localizableWSS_1243_BST_DECODING_ERROR());
    }
    ...
    public static Localizable localizableWSS_1244_NO_ATTACHMENT_FOUND() {
        return messageFactory.getMessage("WSS1244.no.attachment.found");
    }
     ...
     * 
     */
    public static String WSS_1244_NO_ATTACHMENT_FOUND() {
        return localizer.localize(localizableWSS_1244_NO_ATTACHMENT_FOUND());
    }
